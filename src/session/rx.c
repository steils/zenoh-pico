...
static z_result_t _z_handle_request(_z_session_t *zn, _z_n_msg_request_t *req, z_reliability_t reliability,
                                    size_t peer_id) {
    ...
    switch (req->_tag) {
        ...
        case _Z_REQUEST_PUT: {
            ...
            z_result_t ret = _z_transport_manager_send_n_msg_with_lock(
                &zn->_transport_manager, &final, Z_RELIABILITY_RELIABLE, Z_CONGESTION_CONTROL_BLOCK,
                _z_destination_filter_from_single_val(peer_id), _Z_TRANSPORT_TYPE_ALL);
...
z_result_t _z_handle_network_message(_z_session_t *zn, _z_network_message_t *msg, size_t peer_id) {
    ...
    switch (msg->_tag) {
        ...
        case _Z_N_REQUEST:
            ...
            ret = _z_handle_request(zn, &msg->_body._request, msg->_reliability, peer_id);
            break;
