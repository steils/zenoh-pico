...
| `_ZP_FOREACH_FILTERED(name, ptr, var, predicate)`     | Loop over elements matching `predicate`; `var` is assigned before the predicate is evaluated.                                                                                                          |
| `_ZP_CONST_FOREACH_FILTERED(name, ptr, var, predicate)` | `const` counterpart of `_ZP_FOREACH_FILTERED`.                                                                                                                                                        |
...
| `_ZP_FOREACH_VAL_FILTERED(name, ptr, var, predicate)` | Loop over hash-map values matching `predicate`; `var` is assigned before the predicate is evaluated.                                                                                                   |
| `_ZP_CONST_FOREACH_VAL_FILTERED(name, ptr, var, predicate)` | `const` counterpart of `_ZP_FOREACH_VAL_FILTERED`.                                                                                                                                               |
