...
* `Z_TRANSPORT_LEASE`: (DEFAULT: 10000) Link lease duration in milliseconds to announce to other zenoh nodes.
* `Z_TRANSPORT_LEASE_EXPIRE_FACTOR`: (DEFAULT: 3) Default session lease expire factor.
